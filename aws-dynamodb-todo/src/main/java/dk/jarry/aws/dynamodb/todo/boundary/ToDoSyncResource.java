...
public class ToDoSyncResource {
	...
	@Counted(name = "createPerformedSync", description = "How many create have been performed.")
	@Timed(name = "createTimerSync", description = "A measure of how long it takes to perform the primality test.", unit = MetricUnits.MILLISECONDS)
	@POST
